...
export function HyperEvmTransactionList({ address, rpcUrl }: HyperEvmTransactionListProps) {
  return (
    <div className="feature-unavailable">
      ...
      <p>
        HyperEVM transaction history requires an indexer service to efficiently query transactions by address.
        This feature is currently under development.
      </p>
      <p className="feature-unavailable-note">
        <strong>Note:</strong> You can still view individual transactions by entering their hash on the{' '}
        <a href="/">home page</a>.
      </p>
    </div>
  );
